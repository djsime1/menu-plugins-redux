...
local function BuildDrawer()
    ...
    LeftButton.Paint = function(pnl, w, h) derma.SkinHook("Paint", "ButtonLeft", pnl, w, h) end
    LeftButton.Think = function(pnl) pnl:SetPos(drawer:GetWide() / 2 - 65, drawer.y - 10) end

    local RightButton = vgui.Create("DButton")
    RightButton:SetText("")
    RightButton:SetSize(15, 15)
    RightButton:SetVisible(false)
    RightButton.Paint = function(pnl, w, h) derma.SkinHook("Paint", "ButtonRight", pnl, w, h) end
    RightButton.Think = function(pnl) pnl:SetPos(drawer:GetWide() / 2 + 50, drawer.y - 10) end
    ...
    drawer.Paint = function(pnl, w, h) dskin.tex.Tab_Control( 0, 0, w, h ) end
